...
public class Pd6ThomasHuitemaFloydDriver {
    public static void main(String[] args) throws FileNotFoundException {
        Scanner kb = new Scanner(System.in);
        System.out.print("Floyd's Algorithm! Enter file of names: ");
        String fileNames = kb.next() + ".txt"; // cities
        ...
        System.out.println("\nNumber of Edges: " + g.floydEdgeCount());
...
/*******************************      
 ...
 What is the cost?  Enter start city (-1 to exit): Pueblo
